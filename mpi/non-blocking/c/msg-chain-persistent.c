...
int main(int argc, char *argv[])
{
    ...
    MPI_Recv_init(receiveBuffer, size, MPI_INT, source, myid, MPI_COMM_WORLD, &requests[0]);
    MPI_Send_init(message, size, MPI_INT, destination, myid+1, MPI_COMM_WORLD, &requests[1]);
